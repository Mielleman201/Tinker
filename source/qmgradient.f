      subroutine qmgradient (energy,derivs)
      use atoms
      use couple
      use deriv
      use energi
...
c
c      if (use_bond)  call ebond1
c      if (use_angle)  call eangle1
c      if (use_strbnd)  call estrbnd1
c      if (use_urey)  call eurey1
c      if (use_angang)  call eangang1
c      if (use_opbend)  call eopbend1
c      if (use_opdist)  call eopdist1
c      if (use_improp)  call eimprop1
c      if (use_imptor)  call eimptor1
c      if (use_tors)  call etors1
c      if (use_pitors)  call epitors1
c      if (use_strtor)  call estrtor1
c      if (use_angtor)  call eangtor1
